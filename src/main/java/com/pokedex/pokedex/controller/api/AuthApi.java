...
public interface AuthApi {
    ...
    @Operation(summary = "Login con Google", description = "Redirige al flujo de OAuth2 de Google")
    @GetMapping("/oauth2/google")
    void loginWithGoogle(jakarta.servlet.http.HttpServletResponse response) throws java.io.IOException;
}